...
/**
 * Surfaces `accessMode === "PlatformOverride"` in the household shell header
 * — but only when the caller is *not* also a member of this household.
 *
...
export function AccessModeBadge({
  ...
  const t = useTranslations("households.shell.accessMode");
