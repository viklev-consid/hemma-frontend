...
import { ImportWizard } from "@/components/economy/import-wizard";
...
export default async function EconomyImportPage({
  params,
}: {
  ...
  // The wizard's read needs are just the pickers (preview/commit are mutations).
  if (householdId) {
    await Promise.all([
      queryClient
        .prefetchQuery(
